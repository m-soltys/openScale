...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public static final Migration MIGRATION_3_4 = new Migration(3, 4) {
        ...
        public void migrate(SupportSQLiteDatabase database) {
            database.beginTransaction();
            try {
                database.execSQL("ALTER TABLE scaleUsers ADD COLUMN garminLogin TEXT NOT NULL DEFAULT ''");
                database.execSQL("ALTER TABLE scaleUsers ADD COLUMN garminPassword TEXT NOT NULL DEFAULT ''");
                database.execSQL("ALTER TABLE scaleMeasurements ADD COLUMN isSyncedWithGarmin INTEGER NOT NULL DEFAULT 0");
    ...
    public static final Migration MIGRATION_4_5 = new Migration(4, 5) {
        ...
        public void migrate(SupportSQLiteDatabase database) {
            ...
            try {
                ...
                database.execSQL("INSERT INTO scaleMeasurements"
                        + " SELECT id, userId, enabled, datetime, weight, fat, water, muscle, "
                        + "visceralFat, lbm, waist, hip, bone, chest, thigh, biceps, neck, "
                        + "caliper1, caliper2, caliper3, comment FROM scaleMeasurementsOld");
